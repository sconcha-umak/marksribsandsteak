  ...
  return (
    <footer className="bg-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-yellow-400 rounded-full blur-3xl"></div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
                ...
                an unforgettable dining experience with fresh, locally-sourced ingredients.
              </p>
              
              {/* Social media links */}
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-primary rounded-full flex items-center justify-center transition-all duration-300 group">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-gray-300">info@gourmetbistro.com</p>
                </div>
              </div>
            </div>
            ...
            {/* Hours */}
            <div>
              <h4 className="text-xl font-semibold mb-6 text-primary">Opening Hours</h4>
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-medium">10am - 11pm</span>
                </div>
        ...
        <div className="border-t border-gray-800 bg-gray-800 bg-opacity-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="max-w-md mx-auto text-center">
              ...
              <p className="text-gray-300 mb-4 text-sm">Get the latest news about our seasonal menu and special events</p>
              <div className="flex">
                <input 
                  type="email" 
                ...
                />
                <button className="bg-primary hover:bg-yellow-400 text-black px-6 py-2 rounded-r-lg font-medium transition-colors duration-300">
                  Subscribe
                </button>
              </div>
            </div>
